...
def main():
    ...
    try:
        response = utils.get_resources_from_online(credentials=credentials, resource_type=RESOURCE_TYPE,
                                                   fields='id,name,numerator,denominator', param_filter=None)
    ...
    for resource in response[RESOURCE_TYPE]:
        ...
        validation_numerator = utils.validate_expression(credentials, RESOURCE_TYPE, "expression",
    ...
    for resource in response[RESOURCE_TYPE]:
        ...
        if EXPRESSION_NAME in resource:
            validation_expression = utils.validate_expression(credentials, RESOURCE_TYPE, EXPRESSION_NAME,
                                                              expression=resource[EXPRESSION_NAME])
        ...
        if EXPRESSION_NAME in resource:
            validation_filter = utils.validate_expression(credentials, RESOURCE_TYPE, EXPRESSION_NAME,
                                                          expression=resource[EXPRESSION_NAME])
    ...
    if dhis2_version_detail >= 37:
        ...
        for resource in response[RESOURCE_TYPE]:
            ...
            if EXPRESSION_NAME in resource:
                validation_rule_action = utils.validate_pra_expression(credentials, RESOURCE_TYPE, EXPRESSION_NAME,
    ...
    for resource in response[RESOURCE_TYPE]:
        ...
        validation_expression_generator = utils.validate_expression(credentials, RESOURCE_TYPE, "expression",
        ...
        if "sampleSkipTest" in resource:
            validation_expression_sampleSkipTest = utils.validate_expression(credentials, RESOURCE_TYPE, "expression",
                                                                             expression=resource["sampleSkipTest"][
                                                                                 EXPRESSION_NAME])
