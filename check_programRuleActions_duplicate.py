...
if __name__ == "__main__":
    ...
    pr_resources = utils.get_resources_from_online(credentials=credentials, resource_type="programRules", fields="id,name,programRuleActions[programRuleActionType,content,data,dataElement,trackedEntityDataValue,programStageSection,trackedEntityAttribute,messageTemplate]", param_filter=None)
